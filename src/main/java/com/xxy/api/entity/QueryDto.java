...
import com.xxy.api.utils.TypeCaseHelper;
...
public class QueryDto {
    ...
    /*
     *@param condition 查询条件名称  数据库字段
     * @param value  查询条件值 具体值
     */
    public QueryDto put(String condition,Object value){
        this.queryCondition.put(condition,value);
        return (QueryDto)this;
    }
